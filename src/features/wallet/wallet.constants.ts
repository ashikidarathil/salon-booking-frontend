...
export const getThemeColorByRole = (role?: string) => {
  switch (role) {
    case 'STYLIST': return WALLET_CONSTANTS.STYLIST_THEME_COLOR;
    case 'ADMIN': return WALLET_CONSTANTS.ADMIN_THEME_COLOR;
    default: return WALLET_CONSTANTS.DEFAULT_THEME_COLOR;
  }
};
