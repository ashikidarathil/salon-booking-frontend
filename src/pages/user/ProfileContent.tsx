...
export default function ProfileContent() {
  ...
  return (
    ...
    >
      <form onSubmit={handleSave} className="max-w-6xl p-4 sm:p-6 mx-auto space-y-6 sm:space-y-8">
        ...
        {/* Save Button */}
        <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4 pb-10 sm:pb-0">
          <Button
            type="button"
            variant="outline"
            onClick={handleReset}
          ...
          <Button
            ...
            className="w-full sm:w-auto shadow-lg shadow-primary/20 bg-gradient-to-br from-primary to-primary/90 order-1 sm:order-2"
          >
